              ...
              <div className="pt-4 mt-6 border-t border-slate-100 space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 sm:p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-200 text-slate-700 font-black text-xs">
                          A
                        </span>
                        <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Controle</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <button
                        ...
                        <span className="w-px h-3 bg-slate-300 rounded-full"></span>
                        <button 
                    ...
                    <div className="flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-3 py-2 shadow-sm">
                      ...
                      <button onClick={() => copyToClipboard(landingUrlA, "landingA")} className="p-1.5 rounded-md hover:bg-slate-100 transition-colors">
                        {copiedField === "landingA" ? <CheckCircle className="w-4 h-4 text-emerald-600" /> : <Copy className="w-4 h-4 text-slate-400" />}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="bg-violet-50/50 border border-violet-200 rounded-xl p-3 sm:p-4 space-y-3">
                    ...
                    <div className="flex items-center gap-2 bg-white border border-violet-200/60 rounded-lg px-3 py-2 shadow-sm">
                      ...
                      <button onClick={() => copyToClipboard(landingUrlB, "landingB")} className="p-1.5 rounded-md hover:bg-violet-100 transition-colors">
                ...
                <div className="bg-blue-50/70 border border-blue-200/60 rounded-xl p-3.5 flex gap-3 mt-2">
                  <Info className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <div className="space-y-1 text-sm text-blue-900">
                    <p className="font-bold">Dica de tráfego</p>
                    <p className="leading-relaxed">Crie anúncios idênticos apontando cada um para um dos links acima. Depois, acesse a aba <span className="font-semibold text-blue-800">Leads e A/B</span> para descobrir qual converte e qualifica melhor.</p>
                  </div>
                </div>
              </div>
